...
interface Card extends PaymentMethod {
     ...
     * @param {ChargeCardVerificationDetails | StoreCardVerificationDetails} verificationDetails Optional: Card verification details for the transaction.
     *   Used for the [new beta payment flow](https://developer.squareup.com/docs/web-payments/take-card-payment).
     * @param {String} cofToken Optional: The card-on-file token for charging a stored card.
     *   Used for the [new beta payment flow](https://developer.squareup.com/docs/web-payments/sca-charge-card-on-file).
