...
import type { CardFieldNames, CardInputEventTypes } from './enum';
/**
 * @internal
 */
...
/**
 * (Beta) The verification details parameter, passed to the `card.tokenize()` function, for cases in which the buyer is being charged.
 * @example
 ...
 * };
 */
interface ChargeCardVerificationDetails {
    /**
...
/**
 * (Beta) The verification details parameter, passed to the `card.tokenize()` function, for cases in which the card is being stored on file.
 * @example
 * const verificationDetails = {
 *   intent: 'STORE',
 *   billingContact: {
 ...
 * };
 */
interface StoreCardVerificationDetails {
    /**
     * Transactional intent of the payment.
     */
    intent: 'STORE';
...
export { ALLOWED_INPUT_PROPERTIES, ALLOWED_COMPONENT_PROPERTIES, ALLOWED_COMPONENT_STATE_PROPERTIES, ALLOWED_INPUT_TEXT_PROPERTIES, ALLOWED_INPUT_ICON_PROPERTIES, CardOptions, CardBrand, CardClassSelectors, CardDetails, CardInputEvent, CardInputEventState, ChargeCardVerificationDetails, ClassSelectors, CardType, ClientClassSelectors, ComponentPropertyValues, ComponentStatePropertyValues, InputPropertyValues, InputTextPropertyValues, PrepaidType, StoreCardVerificationDetails, StylePropertyList, };
