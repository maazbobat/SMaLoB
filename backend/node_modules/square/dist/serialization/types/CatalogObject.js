...
const CatalogObjectDiningOption_1 = require("./CatalogObjectDiningOption");
const CatalogObjectTaxExemption_1 = require("./CatalogObjectTaxExemption");
const CatalogObjectServiceCharge_1 = require("./CatalogObjectServiceCharge");
...
const CatalogObjectComponent_1 = require("./CatalogObjectComponent");
const CatalogObjectComposition_1 = require("./CatalogObjectComposition");
const CatalogObjectResource_1 = require("./CatalogObjectResource");
const CatalogObjectCheckoutLink_1 = require("./CatalogObjectCheckoutLink");
const CatalogObjectAddress_1 = require("./CatalogObjectAddress");
const CatalogObjectSubscriptionProduct_1 = require("./CatalogObjectSubscriptionProduct");
...
exports.CatalogObject = core.serialization
    ...
    DINING_OPTION: CatalogObjectDiningOption_1.CatalogObjectDiningOption,
    TAX_EXEMPTION: CatalogObjectTaxExemption_1.CatalogObjectTaxExemption,
    SERVICE_CHARGE: CatalogObjectServiceCharge_1.CatalogObjectServiceCharge,
    ...
    COMPONENT: CatalogObjectComponent_1.CatalogObjectComponent,
    COMPOSITION: CatalogObjectComposition_1.CatalogObjectComposition,
    RESOURCE: CatalogObjectResource_1.CatalogObjectResource,
    CHECKOUT_LINK: CatalogObjectCheckoutLink_1.CatalogObjectCheckoutLink,
    ADDRESS: CatalogObjectAddress_1.CatalogObjectAddress,
    SUBSCRIPTION_PRODUCT: CatalogObjectSubscriptionProduct_1.CatalogObjectSubscriptionProduct,
